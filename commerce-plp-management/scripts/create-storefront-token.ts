 ...
 *
 * Dev Dashboard apps don't expose a static Storefront token in the UI, so this
 * creates one via the Admin API. Run once; re-running creates additional tokens.
 *
