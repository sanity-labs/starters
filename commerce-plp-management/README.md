...
badge vocabulary and two example collections (`clothing` and
`holiday-gift-guide-2026`). Open them in Studio and use the **product picker** to
attach real products from your store. Point the `clothing` collection's handle at
a real collection handle in your store to see the merge.
